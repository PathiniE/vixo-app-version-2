...
//       <DialogContent
//         className="w-full max-w-none m-0 p-0 bg-[#191919] border-none text-white fixed bottom-0 left-0 right-0 top-auto translate-x-0 translate-y-0 rounded-t-lg data-[state=open]:slide-in-from-bottom data-[state=closed]:slide-out-to-bottom [&>button]:hidden"
...
const Deposit: React.FC<DepositModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className="w-full max-w-none m-0 p-0 bg-[#191919] border-none text-white fixed bottom-0 left-0 right-0 top-auto translate-x-0 translate-y-0 rounded-t-lg data-[state=open]:slide-in-from-bottom data-[state=closed]:slide-out-to-bottom [&>button]:hidden data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-500 data-[state=open]:duration-300"
        onPointerDownOutside={(e) => e.preventDefault()}
        onEscapeKeyDown={(e) => e.preventDefault()}
      >
        <div className="p-4">
