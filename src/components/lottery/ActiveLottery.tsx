      ...
      <div className="bg-gradient-to-br from-amber-600 via-orange-600 to-red-600 p-0.5 rounded-2xl">
        <div className="bg-black rounded-2xl p-6">
          ...
          <div className="mb-6">
            <div className="flex justify-center space-x-2">
              <div className="text-center">
                <div className="text-white text-xs font-medium mb-2">Hours</div>
              ...
              <div className="text-center">
                <div className="text-white text-xs font-medium mb-2">Minutes</div>
                <div className="bg-[#F4B92E] p-0.5 rounded-lg">
                  <div className="bg-black rounded-lg px-6 py-5 min-w-[80px]">
                    <div className="text-4xl font-bold text-white text-center">
              ...
              <div className="text-white text-3xl font-bold self-end pb-4">:</div>
              <div className="text-center">
                <div className="text-white text-xs font-medium mb-2">Seconds</div>
                <div className="bg-[#F4B92E] p-0.5 rounded-lg">
                  <div className="bg-black rounded-lg px-6 py-5 min-w-[80px]">
                    <div className="text-4xl font-bold text-white text-center">
          ...
          <button
            ...
            className="w-full bg-[#E2531933] text-[#E25319] py-3 px-5 rounded-lg text-xl"
          >
